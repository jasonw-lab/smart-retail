...
import com.youlai.boot.modules.pms.constant.PmsConstants;
import com.youlai.boot.modules.pms.converter.SkuConverter;
import com.youlai.boot.modules.pms.mapper.PmsSkuMapper;
import com.youlai.boot.modules.pms.model.dto.LockSkuDTO;
...
public class SkuServiceImpl extends ServiceImpl<PmsSkuMapper, PmsSku> implements SkuService {
    ...
    public boolean lockStock(String orderToken, List<LockSkuDTO> lockSkuList) {
        ...
        redisTemplate.opsForValue().set(PmsConstants.LOCKED_SKUS_PREFIX + orderToken, lockSkuList);
        return true;
    }
    ...
    public boolean unlockStock(String orderSn) {
        List<LockSkuDTO> lockedSkus = (List<LockSkuDTO>) redisTemplate.opsForValue().get(PmsConstants.LOCKED_SKUS_PREFIX + orderSn);
        ...
        // 移除 redis 订单锁定的商品
        redisTemplate.delete(PmsConstants.LOCKED_SKUS_PREFIX + orderSn);
        return true;
    }
