...
### v1.1対応: 要件定義・UI設計の整合性修正

#### Issue #12: 在庫管理機能強化

**目的**: v1.1要件定義・UI設計で追加された在庫管理機能の強化実装
...
- 期限切れ状態判定と表示
- 状態フィルタに「期限切れ」追加
- 廃棄ダイアログ / 履歴表示ダイアログUI追加

**成果物**:
- InventoryTransaction.java（entity）
- InventoryStatus.java（enum）
- DiscardForm.java / InventoryTransactionVO.java
- 廃棄API / 履歴API
- DiscardDialog.vue / TransactionHistory.vue
- InventoryList.vue拡張
...
**詳細**: `docs/issues/issue-12-v1.1-inventory-enhancement.md`

---

#### Issue #13: アラート自動クローズ・重複抑制機能

**目的**: v1.1要件定義で明確化されたアラート自動クローズ・重複抑制の実装

**スコープ**:
- IN_PROGRESS → RESOLVED自動遷移（条件解消時）
- RESOLVED → CLOSED自動遷移（24時間経過後）
- 重複アラート抑制ロジック
- 優先度昇格ロジック

**成果物**:
- AlertAutoCloseJob.java（バッチジョブ）
- AlertDetectionService拡張
- AlertMapper拡張
...
**詳細**: `docs/issues/issue-13-v1.1-alert-auto-close.md`
...
| **v1.1** | #12 | 在庫管理機能強化（ロット・廃棄・状態判定） | 中 | #4-1, #4-2 |
| **v1.1** | #13 | アラート自動クローズ・重複抑制機能 | 中 | #5-1 |

**合計**: 15 Issues

| Issue番号 | タイトル | ステータス | 担当 | 完了日 | PR |
|----------|---------|----------|------|--------|-----|
| #0-1 | Smart Retail用データベース設計・マイグレーション | ✅ 完了 | - | 2026-02-01 | - |
| #1-1 | ダッシュボード機能(バックエンド) | ✅ 完了 | - | 2026-02-01 | - |
| #1-2 | ダッシュボード機能(フロントエンド) | ✅ 完了 | - | 2026-02-01 | - |
| #2-1 | 店舗管理機能(バックエンド) | ✅ 完了 | - | 2026-02-01 | - |
| #2-2 | 店舗管理機能(フロントエンド) | ✅ 完了 | - | 2026-02-01 | - |
| #3-1 | 商品管理機能(バックエンド) | ✅ 完了 | - | 2026-02-01 | - |
| #3-2 | 商品管理機能(フロントエンド) | ✅ 完了 | - | 2026-02-01 | - |
| #4-1 | 在庫管理機能(バックエンド) | ✅ 完了 | - | 2026-02-01 | - |
| #4-2 | 在庫管理機能(フロントエンド) | ✅ 完了 | - | 2026-02-01 | - |
| #5-1 | アラート管理機能(バックエンド) | 未着手 | - | - | - |
| #5-2 | アラート管理機能(フロントエンド) | 未着手 | - | - | - |
| #6-1 | E2Eテスト実装 | 未着手 | - | - | - |
| #6-2 | パフォーマンステスト・最適化 | 未着手 | - | - | - |
| #12 | 在庫管理機能強化 | 未着手 | - | - | - |
| #13 | アラート自動クローズ・重複抑制機能 | 未着手 | - | - | - |
...
| 2026-02-01 | 1.2 | v1.1対応Issue追加（#12在庫管理強化, #13アラート自動クローズ） | - |
