...
### 顧客管理 (将来構想 / Phase 2以降)
- **遠隔サポート**: 店舗での商品購入時のトラブル対応や決済エラー時の遠隔カスタマーサポートを提供します。
- **返金・返品管理**: 無人決済における返金リクエストの処理と、返品状況の一元管理機能を拡張予定です。
- **会員属性・購買分析**: 店舗公式アプリ等と連携した顧客ごとの購買履歴管理、ポイント付与、マーケティング施策に対応します。
...
*(現在画面キャプチャを準備中です。主要画面：ダッシュボード、店舗一覧、デバイス監視一覧、アラート監視 等)*
