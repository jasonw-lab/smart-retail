...
const mockStoreData = () => {
  const stores = [
    { id: 1, name: "東京本店", sales: 0, target: 0 },
    { id: 2, name: "大阪店", sales: 0, target: 0 },
    { id: 3, name: "名古屋店", sales: 0, target: 0 },
    { id: 4, name: "福岡店", sales: 0, target: 0 },
    { id: 5, name: "札幌店", sales: 0, target: 0 },
    { id: 6, name: "仙台店", sales: 0, target: 0 },
    { id: 7, name: "広島店", sales: 0, target: 0 },
    { id: 8, name: "京都店", sales: 0, target: 0 },
    { id: 9, name: "横浜店", sales: 0, target: 0 },
    { id: 10, name: "神戸店", sales: 0, target: 0 },
  ];
  ...
  return stores.map((store) => {
    const sales = Math.floor(baseSales * (0.8 + Math.random() * 0.4)); // 店舗ごとに±20%の変動
    const target = Math.floor(sales * (0.8 + Math.random() * 0.4)); // 売上の上下20%の範囲で目標値を設定
    return {
      ...store,
      sales,
      target,
